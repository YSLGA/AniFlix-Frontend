...
const AnimeMovieItem = (props) => {
  ...
  const deleteReq = async () => {
    try {
      let response = await axios.delete(`${apiUrl}/animeMovies/${params._id}`);
  ...
  const getReq = async () => {
    try {
      let response = await axios.get(`${apiUrl}/animeMovies/${params._id}`);
      console.log(response.data);
  ...
  return (
    <div className="animeMovieItem">
      <form className="animeMovieItem-text-fields" onSubmit={handleSubmit}>
        <input
